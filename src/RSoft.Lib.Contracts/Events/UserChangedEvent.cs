...
namespace RSoft.Lib.Contracts.Events
{
    ...
    /// <summary>
    /// Occurs when an user is changed/udpated.
    /// </summary>
    public class UserChangedEvent : IMessageEvent
    {
        ...
        public UserChangedEvent(Guid id, string firstName, string lastName, string email, DateTime? bornDate, UserType type, bool isActive)
        {
            Id = id;
            FirstName = firstName;
            LastName = lastName;
