...
namespace RSoft.Lib.DDD.Exceptions
{
    ...
    public class InvalidEntityException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the RSoft.Lib.DDD.Exceptions.InvalidEntityException class with a specified error message.
        /// </summary>
